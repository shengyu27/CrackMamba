...
# Dataset parameters
parser.add_argument('-g', '--gt_path', default='your_address/nnUNet_data/nnUNet_raw/Dataset277_SCrack/labelsTs', type=str, help='path to ground truth')
...
#parser.add_argument('-n', '--save_name', default='', type=str, help='name of the csv file')
